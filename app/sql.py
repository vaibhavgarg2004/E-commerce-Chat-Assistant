...
For example:
1. Campus Women Running Shoes: ₹1104 (35% off), Rating: 4.4 <link>
2. Campus Women Running Shoes: ₹1104 (35% off), Rating: 4.4 <link>
3. Campus Women Running Shoes: ₹1104 (35% off), Rating: 4.4 <link>
...
def sql_chain(question):
    ...
    flipkart_links = re.findall(r'https://www\.flipkart\.com[^\s\)\]]+', answer)
    for link in flipkart_links:
        formatted = f"  \n[🔗 View Product]({link})"
        answer = answer.replace(link, formatted)
